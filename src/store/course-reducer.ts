import { CREATE_COURSE_SUCCESS, DELETE_COURSES_OPTIMISTIC, LOAD_COURSES_SUCCESS, UPDATE_COURSE_SUCCESS } from './course-actions';
...
type KnownAction = CreateCourseAction | UpdateCourseAction | LoadCourseAction | DeleteCourseAction;
